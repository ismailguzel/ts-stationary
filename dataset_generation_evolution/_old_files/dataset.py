...
for base in bases:
    for length_range in length_ranges:
        ...
        if base == "ar":
            generate_ar_dataset(folder=folder_path("stationary", base, l), count=10, length_range=length_range)
        elif base == "ma":
            generate_ma_dataset(folder=folder_path("stationary", base, l), count=10, length_range=length_range)
        elif base == "arma":
            generate_arma_dataset(folder=folder_path("stationary", base, l), count=10, length_range=length_range)
        elif base == "white_noise":
            generate_wn_dataset(folder=folder_path("stationary", base, l), count=10, length_range=length_range)
...
for base in stochastic_bases:
    for length_range in length_ranges:
        ...
        if base == "random_walk":
            generate_random_walk_dataset(folder=folder_path("stochastic", base, l), count=10, length_range=length_range)
        elif base == "random_walk_drift":
            generate_random_walk_with_drift_dataset(folder=folder_path("stochastic", base, l), count=10, length_range=length_range)
        elif base == "ari":
            generate_ari_dataset(folder=folder_path("stochastic", base, l), count=10, length_range=length_range)
        elif base == "ima":
            generate_ima_dataset(folder=folder_path("stochastic", base, l), count=10, length_range=length_range)
        elif base == "arima":
            generate_arima_dataset(folder=folder_path("stochastic", base, l), count=10, length_range=length_range)
...
for base in volatility_bases:
    for length_range in length_ranges:
        ...
        if base == "arch":
            generate_arch_dataset(folder=folder_path("volatility", base, l), count=10, length_range=length_range)
        elif base == "garch":
            generate_garch_dataset(folder=folder_path("volatility", base, l), count=10, length_range=length_range)
        elif base == "egarch":
            generate_egarch_dataset(folder=folder_path("volatility", base, l), count=10, length_range=length_range)
        elif base == "aparch":
            generate_aparch_dataset(folder=folder_path("volatility", base, l), count=10, length_range=length_range)
...
for seasonality in seasonality_types:
    for length_range in length_ranges:
        ...
        if seasonality == 'single':
            generate_single_seasonality_dataset(folder=folder_path("single_seasonality", l), count = 10, length_range=length_range)
        if seasonality == 'multiple':
            #n = random.randint(2,3)
            generate_multiple_seasonality_dataset(folder=folder_path("multiple_seasonality", l), count = 10, length_range=length_range)
        if seasonality == 'sarma':
            if l == 'long':
                pass
            else:
                generate_sarma_dataset(folder=folder_path("sarma_seasonality", l), count = 10, length_range=length_range)
        if seasonality == 'sarima':
            if l == 'long':
                pass
            else:
                generate_sarma_dataset(folder=folder_path("sarima_seasonality", l), count = 10, length_range=length_range)
